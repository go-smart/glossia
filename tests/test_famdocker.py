...
def test_get_needle_parameter  ( monkeypatch , famdocker ) : 
    ...
    result = famdocker.get_needle_parameter ( random_needle_index, random_key, random_try_json )
...
def test_get_parameter  ( monkeypatch , famdocker ) :  
    ...
    result = famdocker.get_parameter ( random_key, random_try_json , random_parameters )
...
def test_load_definition ( monkeypatch , famdocker ) :
    ...
    famdocker.load_core_definition.assert_called_with ( random_xml , random_parameters , random_algorithms )
